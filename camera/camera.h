...
public:
    ...
    glm::mat4 sistema_coordenadas(glm::vec3 cameraPos, glm::vec3 aponta, glm::vec3 up)
    {
        // criando os tres vetores do meu sistema de coordenadas
        glm::vec3 cameraDirection = glm::normalize(cameraPos - aponta);
        ...
        //transposta/inversas (sao igauis por seres ortonormal) para inverter a rotacao
    ...
    {
        return sistema_coordenadas(Position, Position + Front, Up);
    }
